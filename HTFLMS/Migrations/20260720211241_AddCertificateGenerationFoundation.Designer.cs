...
namespace HTFLMS.Migrations
{
    ...
    [Migration("20260720211241_AddCertificateGenerationFoundation")]
    partial class AddCertificateGenerationFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTFLMS.Models.Certificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("BatchEndDateSnapshot")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("BatchStartDateSnapshot")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("DeliveryModeSnapshot")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("DurationSnapshot")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<int?>("StudentCertificateNumberId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TitlePrefixSnapshot")
                        .HasMaxLength(10)
                    ...
                    b.HasIndex("StudentCertificateNumberId");

                    b.HasIndex("StudentId");

                    b.HasIndex("DeliveryMode", "CertificateId")
                        .IsUnique();

                    b.HasIndex("DeliveryMode", "CertificateYear", "BaseNumber", "Suffix")
                        .IsUnique()
                        .HasFilter("[Suffix] IS NOT NULL");
            ...
            modelBuilder.Entity("HTFLMS.Models.CourseEnrollment", b =>
                {
                    ...
                    b.Property<DateTime?>("DeliveryModeUpdatedAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("DeliveryModeUpdatedByUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeliveryModeUpdatedByUserId");
            ...
            modelBuilder.Entity("HTFLMS.Models.QuizAttemptsReset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HTFLMS.Models.StudentCertificateNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeliveryMode", "BaseNumber")
                        .IsUnique();

                    b.HasIndex("StudentId", "DeliveryMode")
                        .IsUnique();

                    b.ToTable("StudentCertificateNumbers");
                });

            modelBuilder.Entity("HTFLMS.Models.StudentCourseNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HTFLMS.Models.Certificate", b =>
                {
                    b.HasOne("HTFLMS.Models.CertificateRequest", "CertificateRequest")
                        .WithMany()
                    ...
                    b.HasOne("HTFLMS.Models.User", "GeneratedByUser")
                        .WithMany()
                        .HasForeignKey("GeneratedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HTFLMS.Models.StudentCertificateNumber", "StudentCertificateNumber")
                        .WithMany("Certificates")
                        .HasForeignKey("StudentCertificateNumberId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("StudentCertificateNumber");
                });
            ...
            modelBuilder.Entity("HTFLMS.Models.CourseEnrollment", b =>
                {
                    ...
                    b.HasOne("HTFLMS.Models.User", "DeliveryModeUpdatedByUser")
                        .WithMany()
                        .HasForeignKey("DeliveryModeUpdatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("DeliveryModeUpdatedByUser");
            ...
            modelBuilder.Entity("HTFLMS.Models.StudentCertificateNumber", b =>
                {
                    b.HasOne("HTFLMS.Models.User", "AssignedByUser")
                        .WithMany()
