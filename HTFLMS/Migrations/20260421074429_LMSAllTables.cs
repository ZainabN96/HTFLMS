        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandbookFilePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CourseImagePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    TrainerId = table.Column<int>(type: "int", nullable: false),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    BatchStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BatchEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateFilePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CertificateRequests_Users_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    SubmittedFilePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FilePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ExternalUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentQuizAttemptAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentQuizAttemptAnswers_QuizOptions_SelectedOptionId",
                        column: x => x.SelectedOptionId,
                        principalTable: "QuizOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentQuizAttemptAnswers_QuizQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "QuizQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentQuizAttemptAnswers_StudentQuizAttempts_AttemptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateRequests_ApprovedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentQuizAttemptAnswers_AttemptId",
                table: "StudentQuizAttemptAnswers",
                column: "AttemptId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentQuizAttemptAnswers_QuestionId",
                table: "StudentQuizAttemptAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentQuizAttemptAnswers_SelectedOptionId",
                table: "StudentQuizAttemptAnswers",
