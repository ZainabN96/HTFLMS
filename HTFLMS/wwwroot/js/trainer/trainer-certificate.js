(function () {
    const apiBaseUrl = '/api/trainer/certificates';
    ...
    async function loadReview() {
        const tableBody = document.getElementById('trainerCertificateTableBody');
        const emptyState = document.getElementById('trainerCertificateEmptyState');
        const tableWrap = document.getElementById('trainerCertificateTableWrap');
    ...
    function renderSummary(summary) {
        setText('certificateClassAverage', `${formatNumber(summary.overallClassAverage)}%`);
        setText('certificatePendingCount', summary.pendingRequests || 0);
        setText('certificateApprovedCount', summary.approved || 0);
        setText('certificateAtRiskCount', summary.atRiskStudents || 0);
    }

    function renderCourseMeta(data) {
        const studentCountEl = document.getElementById('trainerCertificateStudentCount');
        const courseMetaEl = document.getElementById('trainerCertificateCourseMeta');
    ...
    function renderTable(data) {
        const tableHead = document.getElementById('trainerCertificateTableHead');
        const tableBody = document.getElementById('trainerCertificateTableBody');
        const tableWrap = document.getElementById('trainerCertificateTableWrap');
        const emptyState = document.getElementById('trainerCertificateEmptyState');
    ...
    function showConfirmModal(options) {
        return new Promise(resolve => {
            const modal = document.getElementById('trainerCertificateConfirmModal');
            const title = document.getElementById('trainerCertificateConfirmTitle');
            const message = document.getElementById('trainerCertificateConfirmMessage');
            const confirmBtn = document.getElementById('trainerCertificateConfirmBtn');
            const cancelBtn = document.getElementById('trainerCertificateCancelBtn');
    ...
    function showToast(message) {
        const toast = document.getElementById('trainerCertificateToast');
        const messageEl = document.getElementById('trainerCertificateToastMessage');
    ...
    function renderEmpty(message) {
        ...
        setText('trainerCertificateStudentCount', '0 student(s)');
    }
